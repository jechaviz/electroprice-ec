...
const rules = [
  ...
  ['energia/accesorios-ups/tarjetas-snmp', /\b(smartbitt snmp|snmp administrador|tarbit010|tarjeta de administracion de red|viewpower|snmpv3)\b/],
  ...
  ['accesorios/seguridad-fisica', /\b(pa410s|defcon scl|serialized cable lock|nanosaver|kensington k64444|k64444ww|candado seguridad|candado laptop|laptop lock|cable lock)\b/],
  ['computo/laptops', /\b(laptop|notebook|thinkpad|macbook|vivobook|latitude|elitebook|xps)\b/],
  ['computo/almacenamiento/memorias-flash', /\b(high endurance|microsd|micro sd|ausdx64|ausdh32|memdat7020|tarjeta microsd|memoria flash)\b/],
  ...
  ['audio/barras-sonido', /\b(hisense hs2100|hs2100|barra de sonido|soundbar)\b/],
  ...
  ['computo/perifericos/presentadores', /\b(logitech spotlight|spotlight presenter|presentador|presentation remote|moulog1800)\b/],
  ...
  ['punto-de-venta/consumibles/rollos-termicos', /\b(ev 3023c|ev-3023c|ev 3025c|ev-3025c|accevo050|accevo070|rollos de papel termico|papel termico 57)\b/],
  ...
  ['wearables/smartwatches', /\b(55020eku|55020ees|55020eel|huawei band 10|nsw 101|nsw-101|necnon smartwatch|pc 270225|pc-270225|smartwatch|smart watch|banda inteligente)\b/],
