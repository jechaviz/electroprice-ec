...
const rules = [
  ...
  ['seguridad/cctv/camaras-turbohd', /\b(turbohd|turbo hd|ds2ce|ds 2ce|b8turbo|b8 turbo|tbdl500a|topvision|thc b|thcb|colorvu|tvi ahd cvi cvbs)\b/],
  ...
  ['audio/barras-sonido', /\b(creative stage v2|stage v2|hisense hs2100|hs2100|barra de sonido|soundbar)\b/],
