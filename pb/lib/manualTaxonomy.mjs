...
const rules = [
  ...
  ['seguridad/cctv/camaras-ip-wifi', /\b(ezviz|tapo c210|tapoc210|tapo|cs bc1c|cs eb3|cs h80f|scam3db|camara ip|camera ip|camara wifi|camera wifi)\b/],
  ...
  ['computo/accesorios/mochilas-fundas', /\b(cp5724s|ecoloop pro slim backpack|mochila|backpack|maletin|funda laptop)\b/],
  ...
  ['seguridad/epp/proteccion-facial', /\b(pco110|cubpco110|careta|proteccion facial|face shield|cpa nino)\b/],
