...
const rules = [
  ...
  ['seguridad/cctv/camaras-turbohd', /\b(turbohd|turbo hd|ds2ce|ds 2ce|b8turbo|b8 turbo|thc b|thcb|colorvu|tvi ahd cvi cvbs)\b/],
  ...
  ['hogar/electrodomesticos/microondas', /\b(hmms3411dsv|microondas|horno de microondas)\b/],
  ...
  ['computo/componentes/pasta-termica', /\b(br 937412|br-937412|pasta termica|thermal paste|eolox)\b/],
